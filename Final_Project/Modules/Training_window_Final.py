...
class Training_window(QWidget):
    ...
    def init_window(self):
        ...
        label.setFont(QtGui.QFont("Times New Roman" ,8))
        ...
        self.line_edit_1.setFont(QtGui.QFont("Times New Roman", 8))
        ...
        self.line_edit_2.setFont(QtGui.QFont("Times New Roman", 8))
        ...
        self.button.setToolTip("<h5>Go back to Main Menu<h5>")  # Notice using h2 tags From Html
        ...
        self.button_4.setToolTip("<h5>Train the Images!<h5>")  # Notice using h2 tags From Html
    ...
    def Make_CSV_file(self):
        if self.file_path_Tampered == "" or  self.file_path_Authentic == "":
            ...
            msg.setText("Dataset prepared. Click on Train to train the Model")
